...
type
  TfrmScrollRoomEd = class(TForm)
    ...
    procedure lstScrollPropertiesDrawItem(Control: TWinControl; Index: Integer;
      Rect: TRect; State: TOwnerDrawState);
    procedure cmdSetScrollStartClick(Sender: TObject);
...
var
  frmScrollRoomEd: TfrmScrollRoomEd;
...
procedure TfrmScrollRoomEd.DrawScroll();
var
...
procedure TfrmScrollRoomEd.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  FreeAndNil(Chk1Respawn);
  FreeAndNil(Chk2Respawn);
end;

procedure TfrmScrollRoomEd.FormShow(Sender: TObject);
begin
...
procedure TfrmScrollRoomEd.LoadScrollData();
var
  i : Integer;
begin
...
procedure TfrmScrollRoomEd.lstScrollPropertiesClick(Sender: TObject);
begin
  ItemIndex := lstScrollProperties.ItemIndex;
end;

procedure TfrmScrollRoomEd.lstScrollPropertiesDblClick(Sender: TObject);
var
//  NewVal : String;
  Hex : TfrmHex;
...
procedure TfrmScrollRoomEd.lstScrollPropertiesDrawItem(Control: TWinControl;
...
procedure TfrmScrollRoomEd.chkSimpleModeClick(Sender: TObject);
begin
  LoadScrollData();
end;

procedure TfrmScrollRoomEd.cmdCancelClick(Sender: TObject);
begin
  _ROMData.LoadScrollData;
end;

procedure TfrmScrollRoomEd.cmdOKClick(Sender: TObject);
begin
...
procedure TfrmScrollRoomEd.cmdScrollKeyClick(Sender: TObject);
var
...
procedure TfrmScrollRoomEd.cmdSetCheckPoint1Click(Sender: TObject);
begin
...
procedure TfrmScrollRoomEd.cmdSetCheckPoint2Click(Sender: TObject);
begin
  if lstScrollProperties.ItemIndex > -1 then
  begin
...
procedure TfrmScrollRoomEd.cmdSetScrollStartClick(Sender: TObject);
begin
  if lstScrollProperties.ItemIndex > -1 then
  begin
...
function TfrmScrollRoomEd.CreateScrollText(pID : Byte): String;
var
  res : String;
begin
...
function TfrmScrollRoomEd.WorkOutEndOfScrollData() : Integer;
var
  pos : Integer;
begin
  pos := _ScrollStart;
