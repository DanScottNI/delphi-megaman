object frmPreferences: TfrmPreferences
  ...
  object pgcPreferences: TPageControl
    ...
    object tshGeneral: TTabSheet
      ...
      object chkUseStandardScrollLengths: TCheckBox
        Left = 168
        Top = 64
        Width = 249
        Height = 17
        Caption = 'Don'#39't allow edits on screens not part of level'
        TabOrder = 7
      end
    end
    object tshDisplayOptions: TTabSheet
      ...
      object lblSpecObjOutline: TLabel
        Left = 8
        Top = 104
        Width = 109
        Height = 13
        Caption = 'Special Object Outline:'
      end
      ...
      object imgSpecObjOutline: TImage32
        Left = 224
        Top = 104
        Width = 25
        Height = 20
      ...
      object cmdSpecObjOutline: TButton
        Left = 256
        Top = 104
        Width = 25
        Height = 20
        Caption = '...'
        TabOrder = 9
        OnClick = cmdSpecObjOutlineClick
      end
